...
def check_q5(ans):
    expected = pd.read_csv("../input/publicassistance/WICAgencies2014ytd/Pregnant_Women_Participating.csv")
    return ans.head().equals(expected.head())


def answer_q5():
    print("""pd.read_csv("../input/publicassistance/WICAgencies2014ytd/Pregnant_Women_Participating.csv")""")
